...
Найти флаг в сетевом дампе.

### Задание 4.
Написать регулярное выражение наименьшей длины, срабатывающее на приведенных ниже векторах атак XSS и пропускающее тестовые данные.
